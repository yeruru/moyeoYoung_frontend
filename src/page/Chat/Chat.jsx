        ...
        <div className='Chatroom'>
            <div className='chatroom' id="chat-wrap">
                <div className="chatTalk" id='chatt'>
                    ...
                    <input className ="chatInput" disabled={chkLog}
                ...
                <div className='sendZone' id='sendZone'>
                    <div style={{ width:'100%', display:'flex'}}>
                        <input id='msg' className="chatcontent" value={msg} onChange={onText}
                            onKeyDown={(ev) => {if(ev.keyCode === 13){send();}}}  maxLength="50" rows="1" spellCheck="false"></input>
                        <input type='button' className='submitbutton' value='전송' id='btnSend' onClick={send}/>
                    </div>
                </div>
            </div>
        </div>
